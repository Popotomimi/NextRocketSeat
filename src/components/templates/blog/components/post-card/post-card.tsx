...
const PostCard = ({
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className="w-full max-w-2xl rounded-3xl border-[1px] border-gray-400 bg-gray-600 overflow-hidden transition-all duration-300 hover:boder-[1px] hover:border-blue-300">
